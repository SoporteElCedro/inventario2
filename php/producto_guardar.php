<?php
    ...
    $guardar_producto=$guardar_producto->prepare("INSERT INTO producto(producto_codigo,producto_nombre,producto_precio,producto_stock,producto_foto,producto_fecha,categoria_id,usuario_id) VALUES(:codigo,:nombre,:precio,:stock,:foto,:fecha,:categoria,:usuario)");
